...
Point calculate_postition(const Configuration& myConfig)
{
  ...
  currentPosition.x = myConfig.currentPos.x +  (myConfig.length1 * cos(myConfig.phi1 * PI/180) * cos(myConfig.phi0 * PI/180))
  ...
  currentPosition.y = myConfig.currentPos.y +  (myConfig.length1 * sin(myConfig.phi1 * PI/180) * sin(myConfig.phi0 * PI/180))
  ...
  currentPosition.z = myConfig.currentPos.z +  (myConfig.length1 * sin(myConfig.phi1 * PI/180)
