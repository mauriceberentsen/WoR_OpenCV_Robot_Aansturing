...
if("TRUE" STREQUAL "TRUE")
  set(kinematics_SOURCE_PREFIX /home/agit/Documents/github/WoR_OpenCV_Robot_Aansturing/src/wor-r_bp2_ws/src/kinematics)
  set(kinematics_DEVEL_PREFIX /home/agit/Documents/github/WoR_OpenCV_Robot_Aansturing/src/wor-r_bp2_ws/devel)
  ...
  set(kinematics_INSTALL_PREFIX /home/agit/Documents/github/WoR_OpenCV_Robot_Aansturing/src/wor-r_bp2_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'kinematics' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'agit <agit@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'kinematics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/agit/Documents/github/WoR_OpenCV_Robot_Aansturing/src/wor-r_bp2_ws/src/kinematics/${idir}'.  Ask the maintainer 'agit <agit@todo.todo>' to fix it.")
    endif()
